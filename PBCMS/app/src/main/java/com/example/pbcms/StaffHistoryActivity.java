...
public class StaffHistoryActivity extends AppCompatActivity implements OnChartValueSelectedListener {
    ...
    private void setTimeRange(String range) {
        ...
        int activeColor = Color.parseColor("#B85858");
    ...
    private void addDoorHistoryItem(String timestamp, String doorStatus) {
        ...
        if (doorStatus.equalsIgnoreCase("OPEN")) {
            icon.setImageResource(R.drawable.ic_door_open);
        } else {
