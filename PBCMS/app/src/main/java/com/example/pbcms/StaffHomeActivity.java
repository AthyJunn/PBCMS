...
public class StaffHomeActivity extends AppCompatActivity {
    ...
    private ImageButton profileButton, homeButton, historyButton, notificationsButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StaffHomeActivity.this, StaffProfileActivity.class);
                            ...
                            if (!querySnapshot.isEmpty()) {
                                ...
                                db.collection("Admin")
                                        ...
                                        .addOnFailureListener(e -> {
                                            firstName.setText("");
                                            Log.e("StaffHomeActivity", "Failed to load admin name", e);
                                        });
                            }
                        })
                        .addOnFailureListener(e -> {
                            firstName.setText("");
                            Log.e("StaffHomeActivity", "Failed to load staff name", e);
                        });
            } else {
                // Email null fallback
                firstName.setText("");
                Log.e("StaffHomeActivity", "Current user email is null");
            }
        }
        ...
        homeButton.setOnClickListener(v -> {
            updateButtonUI(homeButton);
            startActivity(new Intent(StaffHomeActivity.this, StaffHomeActivity.class));
        });

        historyButton.setOnClickListener(v -> {
            updateButtonUI(historyButton);
            startActivity(new Intent(StaffHomeActivity.this, StaffHistoryActivity.class));
        });

        notificationsButton.setOnClickListener(v -> {
            updateButtonUI(notificationsButton);
            startActivity(new Intent(StaffHomeActivity.this, StaffNotificationsActivity.class));
        });
